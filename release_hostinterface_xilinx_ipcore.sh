...
mkdir -p release/xilinx/axiwrapper
mkdir -p release/xilinx/axiwrapper/src
...
cp xilinx/axiwrapper/src/AxiliteMasterWrapper-rtl-ea.vhd			release/xilinx/axiwrapper/src
cp xilinx/axiwrapper/src/AxiliteSlaveWrapper-rtl-ea.vhd			release/xilinx/axiwrapper/src
